  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-white/70 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Cobalt allows Financial management and visibility in one place
          </p>
          <p className="text-white/70 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Having a vision of a system that allows for financial management, visibility and ease for all individuals
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src={timeline1}
      ...
      content: (
        <div>
          <p className="text-white/70 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Created new components on Cobalt financial system
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-white/70 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Card grid component
            </div>
            <div className="flex gap-2 items-center text-white/70 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Startup for cobalt
