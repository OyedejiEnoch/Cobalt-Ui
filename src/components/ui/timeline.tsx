...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-[#09090B] dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2  className='text-4xl md:text-5xl font-medium bg-gradient-to-r from-[#FFFFFF] via-[#C3C3C6] to-[#71717A] bg-clip-text text-transparent'>
          Cobalt journey from start
        </h2>
        <p className="text-white/50 dark:text-neutral-300 text-sm md:text-base max-w-sm mt-4">
          We&apos;ve been working on cobalt for the past 2 years. Here&apos;s
